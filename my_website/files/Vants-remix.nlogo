...
to setup
  ...
  create-turtles num-vants
    [ face one-of neighbors4
      ifelse color-vants? [
        set color one-of [red green blue orange yellow]
      ]
      [
        set color red
      ]
...
to move
  ifelse color-vants? [
      ifelse color = red
      [;; red behavior
        set move-amount red-speed
      ]
      [
        ifelse color = yellow
        [;; yellow behavior
          set move-amount yellow-speed
        ]
        [
          ifelse color = green
          [;; green behavior
            set move-amount green-speed
          ]
          [
            ifelse color = blue
            [;; blue behavior
              set move-amount blue-speed
            ]
            [;; orange behavior
              set move-amount 5
            ]
      ...
      loop [
        set pcolor color
        fd 1
        set move-amount move-amount - 1
        if move-amount = 0 [stop]
      ]
    ]
    [
      fd 1
